...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.59-kirby-problem-1.59-ab008e2a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.59"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.59-kirby-problem-1.59-ab008e2a-v1",
      "problem_contract_sha256": "3e671bd36e12cd4c42c1dbe78a49d70c0a54f166c49a522a253a4d671f4f94da",
      "problem_id": "problem:um-kp-1.59-kirby-problem-1.59-ab008e2a",
      "route_id": "route:um-kp-1.59-kirby-problem-1.59-ab008e2a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.59-kirby-problem-1.59-ab008e2a-source-fidelity-01",
      "graph_id": "graph:um-kp-1.59-kirby-problem-1.59-ab008e2a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.59-kirby-problem-1.59-ab008e2a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.59-kirby-problem-1.59-ab008e2a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $K \\subset S^{3}$ be a slice knot. (a) Determine the set $\\mathcal{R}(K)$ of ribbon disks bounded by $K$ modulo isotopy. (b) Determine the set $\\mathcal{D}(K)$ of slice disks bounded by $K$ modulo isotopy and local knotting. (c) Determine the set $\\mathcal{H}\\mathcal{R}(K)$ of homotopy-ribbon disks bounded by $K$ modulo isotopy. (d) If $K$ is fibered, determine the set $\\mathcal{F}\\mathcal{H}\\mathcal{R}(K)$ of fibered, homotopy-ribbon disks bounded by $K$ in some homotopy 4-ball, modulo isotopy."
          },
          "statement_sha256": "cdc42983ea45e6deaa2d0f22447961767714880f386e6017b2c7cce982fa0593"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.59-kirby-problem-1.59-ab008e2a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.59-kirby-problem-1.59-ab008e2a-root",
      "route_id": "route:um-kp-1.59-kirby-problem-1.59-ab008e2a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.59-7b7b69f6b455",
        "url": "https://www.unsolvedmath.com/problems/KP-1.59"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
